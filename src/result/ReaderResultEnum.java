...
public enum ReaderResultEnum {
	...
	FILE_NONEXISTING,
	/**
	 * On a commencé à lire les Points mais on a trouvé plus que 3 coordonnées/nombres. Ca se peut qu'il y ait un Point manquant et qu'on a alors lu une Face ou
	 * simplement que l'entête est fausse.
	 */
	TOO_MANY_COORDS,
	/**
	...
	PLY_NOT_FOUND,
	/**
	 * On a commencé à lire les Faces et elle fait référence à un Point inexistant. Ca se peut qu'il y ait un Point manquant ou que la liste de Points de cette
	 * Face est erronée.
	 */
	POINT_NOT_FOUND;
}

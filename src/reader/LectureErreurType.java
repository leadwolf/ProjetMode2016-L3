...
/**
 * Liste d'erreurs possibles lors de la lecture d'un fichier .ply dans {@link Lecture}
 * 
 * @author L3
 *
 */
public class LectureErreurType {
	...
	/**
	 * Constructeur permettant de créer une {@link ErreurType}
	 * @param erreurType
	 */
	public LectureErreurType(ErreurType erreurType) {
		erreur = erreurType;
	}

	/**
	 * @return L'{@link ErreurType}
	 */
